...
//  ImageUploader
//
//  Created by David Proskin on 8/2/18.
...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate, PhotosDataProviderDelegate {
    ...
    // MARK: - Standard View Controller Stuff
...
//    }
    ...
    func configureCell(_ cell:UITableViewCell,  withAsset asset: PHAsset) {
